...
The logical expression language grammar is published as an [EBNF specification](https://github.com/sho1884/NeoCEG/blob/master/Doc/DSL_Grammar_Specification.md). By providing this grammar to an AI assistant, you can ask it to generate cause-effect graphs from natural language requirements — bridging the gap between specifications and test design.
...
論理式言語の文法は [EBNF仕様](https://github.com/sho1884/NeoCEG/blob/master/Doc/DSL_Grammar_Specification.md) として公開されています。この文法をAIアシスタントに渡すことで、自然言語の要求仕様から原因結果グラフを生成させることができ、仕様とテスト設計の橋渡しが可能になります。
...
Special thanks are due to Koichi Akiyama, who tested NeoCEG from an early stage of its development and provided valuable evaluation and feedback.
